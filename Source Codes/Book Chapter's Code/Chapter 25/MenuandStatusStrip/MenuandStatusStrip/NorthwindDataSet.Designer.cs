...
namespace MenuandStatusStrip.NorthwindDataSetTableAdapters {
...
SELECT OrderID, ProductID, UnitPrice, Quantity, Discount FROM [Order Details] WHERE (OrderID = @OrderID) AND (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MenuandStatusStrip.Properties.Settings.Default.NorthwindConnectionString;
        }
