...
<head id="Head1" runat="server">
    <title>Using the Membership Class</title>
    <style type="text/css">
        .style1
        {
            width: 324px;
...
<body>
    ...
    <div>
			...
			<tr>
				<td>Password:</td>
				<td class="style1">
				<asp:textbox id="myPassword" runat="server" textmode="Password"
 				 width="93%"></asp:textbox>
				</td>
			</tr>
			<tr>
				...
				Email:</td>
				<td class="style1">
					<asp:textbox id="myEmail" runat="server"
			...
			<tr>
				...
				Password Answer:</td>
				<td class="style1">
					<asp:textbox id="myPasswordAnswer" runat="server" 
 					width="92%"></asp:textbox>
				</td>
			</tr>                    
			<tr>
				<td style="TEXT-ALIGN: center" colspan="2">
				<asp:Button ID="createbutton" runat="server" text="Click to Create User" onclick="createbutton_Click"/>
				</td>
			</tr>
			</table>
			<br />
