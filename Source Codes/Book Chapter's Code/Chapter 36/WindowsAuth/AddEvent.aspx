<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddEvent.aspx.cs" 
 	Inherits="AddEvent" %>
...
<body>
    ...
    <div>
     <asp:Label ID="Label1" runat="server" Text="Welcome to Kogent Intranet" 
		Font-Bold="True" Font-Names="Arial" Font-Overline="False" 
		...
		<tr>
			<td class="style1">
			<asp:Label ID="Label6" runat="server" Text="Event Location:" Font-
 			Bold="True" 
			Font-Names="Arial"></asp:Label></td>
			<td width="1%">&nbsp;</td>
			<td width="79%">
		...
		<tr>
			...
			<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
 			ConflictDetection="CompareAllValues" ConnectionString="<%$
 			 ConnectionStrings:avantikaConnectionString %>" 
            InsertCommand="INSERT INTO [Events] ([ID], [EventName], [Place], [Time],
 			[CreatedBy]) VALUES (@ID, @EventName, @Place, @Time, @CreatedBy)" >						 			
			<InsertParameters>
				<asp:ControlParameter ControlID="ID" Name="ID" 
 				PropertyName="Text"
 				 Type="Int32" />
				<asp:ControlParameter ControlID="name" Name="EventName" 
 				PropertyName="Text" Type="String" />
				<asp:ControlParameter ControlID="location" Name="Place" 
 				PropertyName="Text" Type="String" />
				<asp:ControlParameter ControlID="time" Name="Time" 
 				PropertyName="Text" Type="String" />
				<asp:ControlParameter ControlID="user" Name="CreatedBy"  
 				PropertyName="Text" Type="String" />
			</InsertParameters>
			</asp:SqlDataSource>
