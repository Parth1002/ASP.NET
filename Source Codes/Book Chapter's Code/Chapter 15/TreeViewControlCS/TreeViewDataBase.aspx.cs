    ...
    public void GetProducts(TreeNode node)
{
    ...
    {
       SqlConnection dbConnection = new SqlConnection("Data Source=.;Initial Catalog=Northwind;Integrated Security=True");
    ...
    protected void TreeView2_TreeNodePopulate(object sender,
